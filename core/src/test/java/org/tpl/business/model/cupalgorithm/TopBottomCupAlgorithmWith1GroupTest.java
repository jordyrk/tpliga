...
public class TopBottomCupAlgorithmWith1GroupTest extends AbstractTopBottomCupAlgorithmTest{
    ...
    public void shouldFindLastBottomRatedTeam() throws Exception {
        ...
        assertEquals(4,fantasyTeam.getTeamId());
    ...
    public void testGetAllMatchesForFirstRound() throws Exception {
        ...
        assertEquals(2,firstRoundMatches.size());
    }
    ...
    public void testCreateAliases() throws Exception {
        ...
        assertEquals(2,firstRoundAliases.size());
    ...
    protected FantasyCup createFantasyCup() {
        ...
        fantasyCup.setNumberOfQualifiedTeamsFromGroups(4);
